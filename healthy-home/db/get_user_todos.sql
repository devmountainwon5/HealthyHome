SELECT u.user_id as user, cd.completed_date_id as id, ut.users_todos_id as todo_ID, list.todo_id as real_todo_id, list.todo_item, cd.completed_date as last_completed_date, list.frequency_id, list.active
